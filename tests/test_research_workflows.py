...
def test_research_guard_allows_taxonomy_terms_in_documentation():
    # These terms are expected in malware/C2 taxonomy and reporting. The guard
    # must not censor defensive documentation just because it names the topic.
    description = "C2 RAT botnet implant loader beacon malware command and control"
